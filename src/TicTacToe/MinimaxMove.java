...
public class MinimaxMove
{
    ...
    public static Move createComputerMove(int[][] inputBoard) throws Exception
    {
    ...
    private static Move makeComputerMove(int[][] gameBoard) throws Exception
    {
